...
local s=net.get('https://github.com/SaphireLattice/shocky_bottle/raw/master/bottles.txt')
local sc=net.get('https://github.com/SaphireLattice/shocky_bottle/raw/master/bottles_'..net.url((channel.name or ""))..'.txt')
if sc then
    s = s..sc
end
local t = split(s,'\n')
